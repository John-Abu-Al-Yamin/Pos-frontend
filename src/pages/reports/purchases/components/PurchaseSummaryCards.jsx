...
const PurchaseSummaryCards = ({ summary, isPending }) => {
  if (isPending) {
    return (
  ...
  const cards = [
    {
      ...
      description: "إجمالي المشتريات الخام",
      accent: "blue",
    },
    {
      icon: Wallet,
      label: "صافي المشتريات",
      value: formatCurrency(summary.net_purchase_amount || 0),
      description: "صافي المشتريات",
      accent: "green",
    },
    {
      icon: Undo2,
      label: "مرتجعات المشتريات",
      value: formatCurrency(summary.total_return_refund || 0),
      description: "مرتجعات المشتريات",
      accent: "red",
    },
    {
      icon: Receipt,
    ...
    },
    {
      ...
      value: summary.total_quantity_purchased ?? 0,
      description: "إجمالي الكمية المشتراة",
      accent: "purple",
    },
    {
      icon: BarChart3,
      label: "الكمية المرتجعة",
      value: summary.total_returned_quantity ?? 0,
      description: "إجمالي الكمية المرتجعة",
      accent: "orange",
    },
  ];
