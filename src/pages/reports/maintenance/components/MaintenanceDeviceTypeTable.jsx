...
const MaintenanceDeviceTypeTable = ({ data, isPending }) => {
  if (isPending) {
    return (
      <Card className="mb-6">
        <CardHeader>
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle className="text-base">الصيانة حسب نوع الجهاز</CardTitle>
      </CardHeader>
...
export default MaintenanceDeviceTypeTable;
