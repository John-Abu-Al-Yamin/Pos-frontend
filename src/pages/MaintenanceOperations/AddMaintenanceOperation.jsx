...
import { useAddMaintenanceOperations } from "@/hooks/Actions/MaintenanceOperations/useCurdsMaintenanceOperations";
...
const AddMaintenanceOperation = () => {
  const navigate = useNavigate();
  const { id } = useParams();

  const { mutate: addMutate, isPending } = useAddMaintenanceOperations();
  ...
  return (
    <div>
      <AddEditHeader
        ...
        description="أدخل بيانات عملية الصيانة"
...
export default AddMaintenanceOperation;
